...
class SearchViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        videoColletionView.register(UINib(nibName: "VideoListCell", bundle: nil), forCellWithReuseIdentifier: cellId)
    }
...
//        let videList = prevController.viewControllers?[0] as! YoutubeListViewController
//        
//        videList.selectedItem = video?.items[indexPath.row]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = videoColletionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! VideoListCell
